...
class DummyProvisionerPlugin(ProvisionerBase):
    ...
    def prepare(self, label:str=UCTT_DUMMY_PROVISIONER_CONFIG_LABEL):
        ...
        self.clients = uctt.new_clients_from_config(self.config, UCTT_DUMMY_PROVISIONER_CONFIG_LABEL, UCTT_DUMMY_PROVISIONER_CONFIG_KEY_CLIENTS)
        self.outputs = uctt.new_outputs_from_config(self.config, UCTT_DUMMY_PROVISIONER_CONFIG_LABEL, UCTT_DUMMY_PROVISIONER_CONFIG_KEY_OUTPUTS)
    ...
    def get_output(self, instance_id:str):
        ...
        if not self.outputs:
            raise ValueError('No outputs have been added to the dummy provisioner')
    ...
    def get_client(self, plugin_id:str='', instance_id:str=''):
        ...
        if not self.clients:
            raise ValueError('No clients have been added to the dummy provisioner')
        return self.clients.get_plugin(plugin_id=plugin_id, instance_id=instance_id)
